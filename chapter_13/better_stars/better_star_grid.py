...
class BetterStarGrid:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Better Star Grid")
    ...
    def _create_grid(self):
        ...
        current_x = (randint(10, 30)/10)*star_width
        ...
        while current_y < (self.settings.screen_height - star_height):
            while current_x < (self.settings.screen_width - star_width):
                ...
                current_x += (randint(10, 60)/10)*star_width

            # Finished a row; reset x value, and increment y value.
            current_x = (randint(10, 30)/10)*star_width
            current_y += (randint(10, 30)/10)*star_height
