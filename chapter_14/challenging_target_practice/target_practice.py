...
class ChallengingTargetPractice:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption(
            "Problem 14-3 - Challenging Target Practice")
        ...
        self._create_target()
        # Start Challenging Target Practice in an inactive state.
    ...
    def _check_bullet_target_collisions(self):
        ...
        if not self.aliens:
            # Destroy existing bullets and create a new target.
            self.bullets.empty()
            self._create_target()
...
if __name__ == '__main__':
    ...
    ai_game = ChallengingTargetPractice()
    ai_game.run_game()
